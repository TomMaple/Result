...
public class LinqExtensionsUnitTests
{
    ...
    [Fact]
    public void Select_NoResultWithSelectorFunction_ThrowsException()
    {
        // Arrange
        const Result<double>? Sut = null;

        // Act
        var exception = Record.Exception(() => Sut!.Select(_ => 428));
    ...
    [Fact]
    public void Select_SuccessfulResultWithNoSelectorFunction_ThrowsException()
    {
        // Arrange
        ...
        // Act
        var exception = Record.Exception(() => sut.Select(Function!));
    ...
    [Fact]
    public void Select_ErrorResultWithNoSelectorFunction_ThrowsException()
    {
        // Arrange
        const Func<double, int>? Function = null;
    ...
    [Fact]
    public void Select_SuccessfulResultWithSelectorFunction_CallsFunction()
    {
        // Arrange
        const double InitialValue = 12.34;
        ...
        // Act
        sut.Select(functionMock.Object);
    ...
    [Fact]
    public void Select_SuccessfulResultWithSelectorFunction_ReturnsFunctionValueResult()
    {
        // Arrange
        ...
        // Act
        var result = sut.Select(x => (int)x - 1);
    ...
    [Fact]
    public void Select_ErrorResultWithSelectorFunction_DoesNotCallFunction()
    {
        // Arrange
        var functionMock = new Mock<Func<double, int>>();
    ...
    [Fact]
    public void Select_ErrorResultWithSelectorFunction_ReturnsOriginalValueResultWithError()
    {
        // Arrange
        var sut = GetErrorResult<double>();

        // Act
        var result = sut.Select(_ => 4873);
