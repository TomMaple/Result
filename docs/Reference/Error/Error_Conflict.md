...
## Remarks
This error category is used when the operation fails due to the data or state conflict (e.g., a unique constraint violation).
...
var error = Error.Conflict(
                ErrorUri.Tag("tag:exampleapp.com,2026:errors:account:update:conflict"),
                "Cannot update the account.",
                "The account was modified in the meantime. Please refresh the data before updating.",
                ErrorUri.Locator("https://api.exampleapp.com/errors/6283365904847834/details"),
                "errors.account.update.conflict",
