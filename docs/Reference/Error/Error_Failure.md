...
Creates a new instance of the [Error](Error.md) object of the *Failure* category.

## Overloads
| Name                             | Description                                                |
| -------------------------------- | ---------------------------------------------------------- |
| [Failure(ErrorUri, String, String, ErrorUri, String, (String, Object)[])](#failureerroruri-string-string-erroruri-string-string-object) | Creates a new expected error with specified parameters. |
| [Failure(ErrorUri, String, String, ErrorUri, String, IEnumerable<KeyValuePair<String, Object>>)](#failureerroruri-string-string-erroruri-string-ienumerablekeyvaluepairstring-object) | Creates a new expected error with specified parameters. |

## Remarks
This error category represents expected errors that are not critical to the operation.
...
A new instance of the [Error](Error.md) class of the *Failure* [ErrorCategory](../ErrorCategory.md) initialized with provided parameters.
...
var error = Error.Failure(
                ...
                "errors.payment.insufficient.funds",
                ("paymentId", "GVX235346"));
```
...
var error = Error.Failure(
                ...
                ErrorUri.Locator("https://api.exampleapp.com/errors/7983750923784025/details"),
                "errors.payment.insufficient.funds",
                new Dictionary<string, object> { ["paymentId"] = "GVX235346" });
```
