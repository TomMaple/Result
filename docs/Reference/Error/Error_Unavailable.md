...
Creates a new instance of the [Error](Error.md) object of the *Unavailable* category.

## Overloads
| Name | Description |
| ---- | ----------- |
| [Unavailable(ErrorUri, String, String, ErrorUri, String, (String, Object)[])](#unavailableerroruri-string-string-erroruri-string-string-object) | Creates a new unavailable error with specified parameters. |
| [Unavailable(ErrorUri, String, String, ErrorUri, String, IEnumerable<KeyValuePair<String, Object>>)](#unavailableerroruri-string-string-erroruri-string-ienumerablekeyvaluepairstring-object) | Creates a new unavailable error with specified parameters. |

## Remarks
This error category is used when one or more resources to complete the operation was/were not available.

It relates to `503` HTTP status code (Service Unavailable), but can also be used in other contexts where a resource was unavailable and needs to be reported.


## Unavailable(ErrorUri, String, String, ErrorUri, String, (String, Object)[])
Source: <a href="https://github.com/TomMaple/Result/blob/main/src/Maple.Result/Error.cs#L921" target="_blank">Error.cs</a>
...
A new instance of the [Error](Error.md) record of the *Unavailable* [ErrorCategory](../ErrorCategory.md) initialized with provided parameters.
...
var error = Error.Unavailable(
                ErrorUri.Tag("tag:exampleapp.com,2026:errors:common:unavailable"),
                "Cannot update the account.",
                "The UserService is unavaiable. Please retry.",
                ErrorUri.Locator("https://api.exampleapp.com/errors/546523452/details"),
                "errors.common.userservice.unavailable",
...
Source: <a href="https://github.com/TomMaple/Result/blob/main/src/Maple.Result/Error.cs#L960" target="_blank">Error.cs</a>
